...
import Lecture.Lecture5.Ex002Phonebook.Config;
import Lecture.Lecture5.Ex002Phonebook.Core.MVP.Presenter;
import Lecture.Lecture5.Ex002Phonebook.Core.MVP.View;
    ...
    public static void ButtonClick() {
        ...
        try (Scanner in = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                switch (key) {
                    case "1":
                        presenter.prev(); // предыдущая запись
                        break;
                    case "2":
                        presenter.next(); // следующая запись
                        break;
